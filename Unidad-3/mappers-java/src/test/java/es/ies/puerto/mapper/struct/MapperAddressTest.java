...
import es.ies.puerto.mapper.classic.MapperHelps;
...
public class MapperAddressTest extends MapperHelps {
    ...
    public void addressToAddressDtoTest(){
        addressDtoMapper= IMapperAddress.INTANCE.addressToAddressDto(addressEntity);
        ...
        Assertions.assertEquals(addressDto.getIsla(),addressDtoMapper.getIsla(),"No son iguales");

    }

    @Test
    public void addressDtoToAddressTest(){
        addressEntityMapper= IMapperAddress.INTANCE.addressDtoToAddress(addressDto);
        ...
        Assertions.assertEquals(addressEntity.getProvincia(),addressEntityMapper.getProvincia(),"No son iguales");
    }
