...
public class FileXmlTest {
    ...
    ICrudOperaciones fileXml;
    List<Persona> personas;

    @BeforeEach
    public void beforeEach() {
        fileXml = new FileCsv();
        personas = fileXml.obtenerPersonas();
    }
    ...
    public void obtenerPersonaTest() {
        ...
        personaBuscar = fileXml.obtenerPersona(personaBuscar);
    ...
    public void addDeletePersonaTest() {
        ...
        fileXml.addPersona(personaInsertar);
        personas = fileXml.obtenerPersonas();
        ...
        fileXml.deletePersona(personaInsertar);
        personas = fileXml.obtenerPersonas();
